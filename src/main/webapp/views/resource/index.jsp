    ...
    <div class="space-y-5 sm:space-y-6">
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="px-5 py-4 sm:px-6 sm:py-5 flex justify-between items-center">
                ...
                <a href="${pageContext.request.contextPath}/resource/create"
                        ...
                        <table class="min-w-full">
                            ...
                            <% for (Resource res : resources) { %>
                                <tr>
                                    ...
                                    <td class="px-5 py-4 sm:px-6">
                                        <div class="flex items-center">
                                            <a href="${pageContext.request.contextPath}/resource/update?id=<%= res.getResourceId() %>" class="block px-4 py-1 text-white bg-warning-500 hover:bg-warning-200 focus:ring-2 focus:ring-blue-300 rounded-lg shadow-md transition-all mr-2">
