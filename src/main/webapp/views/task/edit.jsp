...
<%@ page import="com.ConstructionXpert.model.ConsumedResource" %>
...
<%
    ...
    String jsonMapedResources = (String) request.getAttribute("jsonMapedResources");
        ...
        <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
            ...
            <nav>
                <ol class="flex items-center gap-1.5">
                    ...
                    <li class="text-sm text-gray-800 dark:text-white/90">edit task</li>
                </ol>
            </nav>
        </div>
    </div>
...
<%--    <% } %>--%>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
            <!-- Elements -->
            <form action="${pageContext.request.contextPath}/tasks/update?projectId=<%= projectId %>&taskId=<%= task.getTaskId() %>" method="POST">
                <div class="mb-5">
                    ...
                    <div class="relative">
                        <input
                                type="text"
                                value="<%= old != null ? old.getName() : task != null ? task.getName() : "" %>"
                                name="name"
                ...
                <div class="mb-5">
                    ...
                    <textarea
                            ...
                            type="text" rows="6"
                            name="description"
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"><%= old != null ? old.getDescription() : task != null ? task.getDescription() : "" %></textarea>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 mb-5">
                    <div>
                        ...
                        <div class="relative">
                            <input
                                    type="date"
                                    value="<%= old != null ? old.getStartDate() : task != null ? task.getStartDate() : "" %>"
                                    name="startDate"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                    type="date"
                                    name="endDate"
                                    value="<%= old != null ? old.getEndDate() : task != null ? task.getEndDate() : "" %>"
